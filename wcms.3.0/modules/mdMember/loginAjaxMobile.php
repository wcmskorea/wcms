...
<div class="cube"><div class="line bg_white" style="height:100px;">
  <div style="padding:10px 0 0 20px;">
    <div class="loginBox">
      ...
      ?>
        <div id="form">
          <label for="uid">아　이　디</label> <input type="text" id="uid" name="uid" class="input_blue" required="required" opt="userid" style="width:120px" title="<?php echo($lang['member']['id']);?>" value="<?php echo($_COOKIE['USERID']);?>" accesskey="L" />
  ...
  <div style="margin-top:10px;padding-left:10px;">
    <ul>
      <?php
      if($cfg['site']['ssl']) { echo('<li class="red">※&nbsp;SSL(128Bit) 암호화 전송</li>'); }
      ?>
      <li class="darkgray" style="line-height:20px"><img src="<?php echo($cfg['droot']);?>common/image/icon/icon_aw_dw_ani.gif" width="10" height="10" alt="<?php echo($lang['member']['regist']);?>" />&nbsp;<a href="<?php echo($cfg['droot'].$cfg['skin']);?>/index.php?cate=000002002"><strong><?php echo($lang['member']['regist']);?></strong> 바로가기 <?php if($func->checkModule('mdMileage') && $cfg['mileage']['mileageReg'] > 0) { echo('<span>(<strong class="colorRed">'.number_format($cfg['mileage']['mileageReg']).'포인트</strong> 적립!)</span>'); } ?></a></li>
      <li class="darkgray" style="line-height:20px"><img src="<?php echo($cfg['droot']);?>common/image/icon/icon_aw_dw.gif" width="10" height="10" alt="<?php echo($lang['member']['find']);?>" />&nbsp;<a href="./index.php?cate=000002003"><?php echo($lang['member']['find']);?> 바로가기</a></li>
    </ul>
  </div>
</div></div>
</form>
