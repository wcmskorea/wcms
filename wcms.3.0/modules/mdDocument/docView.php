...
if($cfg['module']['list'] == 'View' && !$_GET['num'])
{
	$_GET['num'] = $db->queryFetchOne(" SELECT seq FROM `".$cfg['cate']['mode']."__content".$prefix."` WHERE cate='".$cfg['module']['cate']."' AND idxTrash='0' ORDER BY idx DESC Limit 1 ");
}
...
$content		= ($_GET['num']) ? stripslashes($Rows['content']) : "현재 등록된 게시물이 없습니다.";
