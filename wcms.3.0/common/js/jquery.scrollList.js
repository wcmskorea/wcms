(function($) {
    $.fn.extend({
        scrollList : function(direction, pixels_per_second, delay) {
            if ('undefined' == typeof(pixels_per_second)) { pixels_per_second = 20; }
            ...
            if ('static' == $list.css('position')) { $list.css('position', 'relative'); }
