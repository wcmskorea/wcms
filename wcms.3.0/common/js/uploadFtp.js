...
NFUpload.prototype.GetFlashTag = function() {
    ...
    {
        flashTag = "<div class=\"pd5\"><embed type=\"application/x-shockwave-flash\" src=\"" + this.GetValue("FlashUrl") + "\" width=\"" + this.GetValue("Width") + "\" height=\"" + this.GetValue("Height") + "\"";
        flashTag += " Id=\"" + this.GetValue("NFUploadId") + "\" name=\"" + this.GetValue("NFUploadId") + "\" quality=\"high\" bgcolor=\"\" type=\"application/x-shockwave-flash\"";
        flashTag += " allDomain=\"allDomain.com\"";
        flashTag += " flashvars=\"" +  this.GetFlashVars() + "\" /></div>";
    } else
    {
        flashTag = "<div class=\"pd5\"><object classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" width=\"" + this.GetValue("Width") + "\" height=\"" + this.GetValue("Height") + "\"";
        ...
        flashTag += "<param name=\"bgcolor\" value=\"\" />";
        flashTag += "<param name=\"quality\" value=\"high\" />";
        flashTag += "<param name=\"flashvars\" value=\"" + this.GetFlashVars() + "\" />";
        flashTag += "</object></div>";
    }
		flashTag += "<div class=\"pd5 center\"><span class=\"btnPack medium icon strong\"><span class=\"check\"></span><button type=\"submit\" onclick=\"NfUpload.FileUpload()\">전송하기</button></span></div>";
    return flashTag;
};
...
NFUpload.prototype.Load = function() {
    //document.write(this.GetFlashTag());
		$("#ajax_display").html(this.GetFlashTag()).appendTo('body');
};
