...
<script type="text/javascript" src="<?php echo($cfg['droot']);?>common/js/checkForm.js"></script>
...
function chkImg (el)
{
    ...
    var extArray = new Array(".swf", ".asf", ".wmv");
	extArray.join(" ");
    ...
    if (allowSubmit) {
       return true;
        ...
        alert("미디어 삽입은 SWF, ASF, WMV 파일만 가능합니다. 다시 선택하여 주십시요.");
				el.select();
...
<input type="hidden" name="type" value="<?php echo($sess->encode('editorMediaPost'));?>" />
<input type="hidden" name="cate" value="<?php echo(__CATE__);?>" />
<input type="hidden" name="op" value="image" />
<fieldset style="float:left;"><legend><span class="normal"><strong>파일 URL경로</strong></span></legend>
    <div style="padding:10px; text-align:center">
			<input type="text" name="murl" class="input_gray" style="width:200px;background:#fff;" value="" />
    </div>
</fieldset>
<fieldset style="float:right;"><legend><span class="normal"><strong>사 이 즈</strong></legend>
    <div style="padding:10px; text-align:center">
...
<div style="margin:10px 0px 10px 0px">
	<fieldset><legend><span class="normal">화면의 위치선택</span></legend>
	<div style="padding:10px; text-align:center">
