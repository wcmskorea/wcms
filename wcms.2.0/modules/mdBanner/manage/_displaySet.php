...
<table class="table_list" summary="Display(배너·이미지 모듈) 유닛설정">
	...
	$form->add('radio', array('true'=>'노출함','false'=>'노출안함'), $config['docBtn'], 'color:#000;');
	$form->addEnd(0);
	$form->addHtml('<td class="small_gray bg_gray"><ol><li><span>슬라이드 이전,다음 버튼 노출 설정</span>');
	$form->addEnd(1);

	$form->addStart('슬라이드 페이징', 'docPager', 1, 0, 'M');
	$form->add('radio', array('true'=>'노출함','false'=>'노출안함'), $config['docPager'], 'color:#000;');
	$form->addEnd(0);
	$form->addHtml('<td class="small_gray bg_gray"><ol><li><span>슬라이드 페이징 버튼 노출 설정</span>');
	$form->addEnd(1);
	
	$form->addStart('슬라이드 캡션', 'docCaption', 1, 0, 'M');
	$form->add('radio', array('true'=>'노출함','false'=>'노출안함'), $config['docCaption'], 'color:#000;');
	$form->addEnd(0);
	$form->addHtml('<td class="small_gray bg_gray"><ol><li><span>슬라이드 캡션 노출 설정</span>');
	$form->addEnd(1);
	/*
