...
<div id="find_wrap">
	<div class="find_container" style="width:670px;">
		...
		<div class="cell" style="padding-right:20px;">
			<form name="reg" method="post" action="<?=$_SERVER['PHP_SELF']?>" enctype="multipart/form-data" onsubmit="return $.checkFarm(this,'./modules/mdMember/findPassBiz.php','30');">
			...
			<div class="box_contents">
				<ul>
					<li><p class="opt"><?=$lang['member_bizno']?> : ( '-' 제외 )<br /><input type="text" name="bizno" class="input_gray" style="width:190px" req="required" opt="bizno" title="<?=$lang['member_bizno']?>" value="" /></p></li>
