...
<colgroup>
    ...
    $form->add('radio', array('Basic'=>'일반용','Gov'=>'기관용','School'=>'학교용'), $config['form'], 'color:black;');
    $form->addEnd(0);
    $form->addHtml('<td class="small_gray bg_gray">회원가입 양식 설정</td>');
    $form->addEnd(1);

    $form->addStart('실명인증 서비스', 'cert', 1, 0, 'M');
    $form->add('radio', array('Pass'=>'사용안함','Rname'=>'실명인증','Gpin'=>'I-PIN','Both'=>'실명+I-PIN'), $config['cert'], 'color:black;');
    $form->addEnd(0);
