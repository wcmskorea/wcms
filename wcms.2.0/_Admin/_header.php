...
<div class="gnb">
	...
	<ul>
		...
		<li class="depth3" style="width:130px;"><a href="http://www.aceoa.com" target="_blank" class="actaqua"><span style="font-size:10px; color:#ffffcc;">POWERD BY</span><br />WCMS v<?php echo($cfg['version']);?></a></li>
		...
		<?php if($_SESSION['ulevel'] < $cfg['operator']) { ?><li class="depth2" style="width:60px;"><a href="javascript:;" onclick="new_window('http://192.168.0.105/_Admin/tools/db/','wftp','1024','768','no','yes');" class="actviolet">DB 관리</a></li><?php } ?>
...
<div class="lnb">
	<ul>
		<li class="menu1"><span class="btnPack black small"><!--<a href="javascript:;" onclick="$.insert('#module','./site/link.php?link=<?php echo($cfg['droot']);?>index.php',null,'300');" style="width:90px;">--><a href="<?php echo($cfg['droot']);?>" style="width:90px;" target="_blank">홈페이지열기</a></span>&nbsp;<span class="btnPack black small"><a href="<?php echo($cfg['droot']);?>_Admin/_logout.php">로그아웃</a></span></li>
		<!--<li class="menu3"><span class="btnPack black small icon"><span class="download"></span><a href="">메뉴얼다운</a></span></li>
		<li class="menu3"><span class="btnPack black small icon"><span class="calendar"></span><a href="javascript:;" onclick="$.dialog('./tools/calculator.php',null,230,140);">계산기</a></span></li>-->
		...
		<?php if($_SESSION['ulevel'] == '1') { ?><!--<li class="menu2"><span class="btnPack white small icon"><span class="refresh"></span><a href="javascript:;" onclick="$.dialog('./tools/siteChange.php',null,300,33);">사이트변경</a></span></li>--><?php } ?>
		<li class="menu2"><span class="btnPack black small"><a href="javascript:;" onclick="$.dialog('../modules/mdDocument/manage/search.php',null,320,100);">문서검색</a></span></li>
		<?php
		//회원검색 버튼
		if($func->checkModule('mdMember')) { echo('<li class="menu2"><span class="btnPack black small"><a href="javascript:;" onclick="$.dialog(\'../modules/mdMember/manage/search.php\',null,320,100);">회원검색</a></span></li>'); }
		?>
	</ul>
	<div class="clear"></div>
</div>
