...
<table class="table_list" style="width:100%;">
	...
	?>
	<tr>
		<th><label for="name" class="required"><span class="colorRed" title="필수입력항목">*</span><strong>PHP파일 선택</strong></label></th>
		<td>
		<ol>
	...
	$form->addStart('z-index 값', 'zindex', 1);
	$form->add('input', 'zindex', $config['zindex'], 'width:60px;','digits="true" maxlength="4"');
	$form->addEnd(0);
	$form->addHtml('<td class="small_gray bg_gray"><ol><li class="opt"><span>BOX z-index 값 설정</span>');
	$form->addEnd(1);
